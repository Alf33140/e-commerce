 ...
 */
final class Version20260317122030 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cost (id INT AUTO_INCREMENT NOT NULL, city VARCHAR(50) NOT NULL, cost VARCHAR(20) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
