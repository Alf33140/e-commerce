 ...
 */
final class Version20260323090843 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_product (id INT AUTO_INCREMENT NOT NULL, quantity INT NOT NULL, _order_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_2530ADE6A35F2858 (_order_id), INDEX IDX_2530ADE64584665A (product_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
