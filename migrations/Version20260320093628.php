 ...
 */
final class Version20260320093628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cost CHANGE cost cost DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cost CHANGE cost cost VARCHAR(20) NOT NULL');
